...
```sh
curl -fsSLo linux.sh https://dot.theojs.cn/Tools/linux.sh && chmod +x linux.sh && ./linux.sh
```

一行下载并检查环境，不修改系统：

```sh
curl -fsSLo linux.sh https://dot.theojs.cn/Tools/linux.sh && chmod +x linux.sh && ./linux.sh --check
```
...
```sh
curl -fsSLo mrs.sh https://dot.theojs.cn/Tools/mrs.sh && chmod +x mrs.sh && ./mrs.sh /path/to/rules
```
...
```sh
curl -fsSLo smartcore.sh https://dot.theojs.cn/Tools/smartcore.sh && chmod +x smartcore.sh && ./smartcore.sh
```

一行下载并自动更新，适合计划任务：

```sh
curl -fsSLo smartcore.sh https://dot.theojs.cn/Tools/smartcore.sh && chmod +x smartcore.sh && ./smartcore.sh --auto
```
